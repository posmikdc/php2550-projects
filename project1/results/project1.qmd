...
modelsummary::modelsummary(
  ...
  title = "Comparison of Simple and Quadratic Linear Models for Age and Completion Time",
)
...
lm_weather <- 
  lm(completion_time ~ perc_rh + sr_wm2 + wind + wbgt + aqi_median, 
  data = main_dta)
